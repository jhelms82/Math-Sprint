...
function createEquations() {
  ...
  console.log('Correct answer:', correctEquations);
  // Set amount of wrong equations
  const wrongEquations = questionAmount - correctEquations;
  console.log('wrong answer:', wrongEquations);
...
//Display 3,2,1 to countdown page
